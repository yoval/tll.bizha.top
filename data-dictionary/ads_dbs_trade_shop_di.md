...
|---------|----------|----------|--------|----------|------|
| business_date | BIGINT | 是 |  | 日期 | 20230108 |
...
| bussiness_type | VARCHAR(255) | 是 |  | 业务类型 | 外卖 |
| anal_type | VARCHAR(255) | 是 |  | 分析类型:到家、到店 | 到家 |
...
| total_amount | DECIMAL(16,2) | 是 |  | 流水金额 | 24.00 |
| total_amount_last_day | DECIMAL(16,2) | 是 |  | 上一天流水金额 | 182.00 |
| total_amount_last_week | DECIMAL(16,2) | 是 |  | 上一周流水金额 | 165.00 |
| total_amount_last_year | DECIMAL(16,2) | 是 |  | 去年同期流水金额 | 0.00 |
| pay_amount | DECIMAL(16,2) | 是 |  | 实收金额 | 14.38 |
| pay_amount_last_day | DECIMAL(16,2) | 是 |  | 上一天实收金额 | 165.00 |
| pay_amount_last_week | DECIMAL(16,2) | 是 |  | 上一周实收金额 | 0.00 |
| pay_amount_last_year | DECIMAL(16,2) | 是 |  | 去年同期实收金额 | 0.00 |
| order_count | BIGINT | 是 |  | 订单量 | 1 |
| order_count_last_day | BIGINT | 是 |  | 上一天订单量 | 14 |
| order_count_last_week | BIGINT | 是 |  | 上一周订单量 | 18 |
...
| discount_amount | DECIMAL(16,2) | 是 |  | 优惠金额 | 9.26 |
...
| dp_item_count_last_day | BIGINT | 是 |  | 上一天商品销量 | 12 |
| dp_item_count_last_week | BIGINT | 是 |  | 上一周商品销量 | 42 |
| dp_item_count_last_year | BIGINT | 是 |  | 去年同期商品销量 | 0 |
| dp_total_amount | DECIMAL(16,2) | 是 |  | 商品流水金额 | 218.00 |
| dp_total_amount_last_day | DECIMAL(16,2) | 是 |  | 上一天商品流水金额 | 182.00 |
...
| return_order_count_last_day | BIGINT | 是 |  | 上一天退款订单量 | 0 |
...
| load_time | VARCHAR(255) | 是 |  | 数据更新时间 | 2024-11-20 16:28:10 |
| is_dj_sold_shop | BIGINT | 是 |  | 是否有外卖业绩门店 | 0 |
| is_dj_sold_shop_last_day | BIGINT | 是 |  | 上一天是否有外卖业绩门店 | 0 |
...
| up_1_order_count | BIGINT | 是 |  | 2杯及以上订单量 | 1 |
| up_1_order_count_last_day | BIGINT | 是 |  | 上一天2杯及以上订单量 | 8 |
...
| channel_name | VARCHAR(255) | 是 |  | 渠道 | 美团外卖 |
